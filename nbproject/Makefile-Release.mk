...
${OBJECTDIR}/_ext/bab0b6eb/Drone.o: /home/tim/NetBeansProjects/OpenGL_Test/Drone.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bab0b6eb/Drone.o /home/tim/NetBeansProjects/OpenGL_Test/Drone.cpp

${OBJECTDIR}/_ext/bab0b6eb/Vector.o: /home/tim/NetBeansProjects/OpenGL_Test/Vector.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/bab0b6eb
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bab0b6eb/Vector.o /home/tim/NetBeansProjects/OpenGL_Test/Vector.cpp

${OBJECTDIR}/_ext/bab0b6eb/Wuerfel.o: /home/tim/NetBeansProjects/OpenGL_Test/Wuerfel.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/bab0b6eb
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bab0b6eb/Wuerfel.o /home/tim/NetBeansProjects/OpenGL_Test/Wuerfel.cpp
...
${OBJECTDIR}/main_3.o: main_3.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_3.o main_3.cpp

${OBJECTDIR}/main_4.o: main_4.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_4.o main_4.cpp

${OBJECTDIR}/main_drone.o: main_drone.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_drone.o main_drone.cpp
